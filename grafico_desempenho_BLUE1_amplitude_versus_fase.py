...
def leitura_dados_estatisticos_desempenho_amplitude_versus_fase_BLUE1(parametro, n_janelamento_ideal, opcao_avaliacao_desempenho):
    ...
    arquivo_dados_estatisticos_desempenho = f"k_fold_{parametro}_{opcao_avaliacao_desempenho}_desempenho_BLUE1_J_{n_janelamento_ideal}.txt"
...
### ------ 2) INSTRUÇÃO PARA O PLOTE DO GRÁFICO DO DADO ESTATÍSTICO DO DESEMPENHO AO LONGO DAS OCUPAÇÕES PARA O JANELAMENTO IDEAL DA ESTIMAÇÃO DA AMPLITUDE VERSUS A FASE PELO MÉTODO BLUE1 ------- ###

# Definição da instrução para o plote do gráfico do dado estatístico do desempenho ao longo das ocupações para o janelamento ideal da estimação da amplitude versus fase pelo método BLUE1.
def grafico_dado_estatistico_desempenho_amplitude_versus_fase_BLUE1(opcao_avaliacao_desempenho, Matriz_Dados_Desempenho):
    ...
    if opcao_avaliacao_desempenho == 1:
        ...
        plt.ylabel(r"Média do erro médio de estimação (ADC Count x ns)", fontsize = 18)
    ...
    if opcao_avaliacao_desempenho == 2:
        ...
        plt.ylabel(r"Média do erro médio quadrático (ADC Count x ns)^2", fontsize = 18)
    ...
    # Caso a variável opcao_avaliacao_desempenho seja 3.
        ...
        plt.ylabel(r"Média do erro médio absoluto (ADC Count x ns)", fontsize = 18)
    ...
    # Caso a variável opcao_avaliacao_desempenho seja 5.
        ...
        plt.ylabel(r"Média do desvio padrão (ADC Count x ns)", fontsize = 18)
...
def principal_grafico_dado_estatistico_desempenho_amplitude_versus_fase_BLUE1():
    ...
    # A variável n_janelamento_ideal recebe o valor do janelamento ideal do método BLUE 1 para a estimação da amplitude versus a fase.
